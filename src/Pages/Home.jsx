   ...
   return (
      ...
      <header>
        ...
        <section className="special-section">
          ...
          <div className="carousel-countainer relative">
            ...
            > 
             <AnimeCard page={special_page} path={TMDB.Top_api+api_key} />
            </div>
          </div>
        </section>
      </header>
      ...
      <section className="people mb-2">
        ...
        <div className="peopleCarousel relative">
             ...
             <People path={"https://api.themoviedb.org/3/trending/person/day?api_key="+api_key} page={peoplePage}/>
        </div>
      </section>
        ...
        <div className="carousel-countainer">
          ...
          <div
            className="carousel-cards-holder d-flex d-flex flex-center gap-3  gap-3 pb-3">
               <AnimeCard 
                      page={trending_page}
                      path={`https://api.themoviedb.org/3/trending/movie/week?language=en-US&api_key=03760268c2411e2d785ed677c960080d`}
                      />
          </div>
        </div>
      </section>
       ...
       <h1 className="section-title">Most Popular :</h1>
        <div className="carousel-countainer">
          ...
          >
             <AnimeCard
               page={popular_page}
              path="https://api.themoviedb.org/3/movie/popular?language=en-US&api_key=03760268c2411e2d785ed677c960080d"
              /> 
          </div>
        </div>
